...
public class WebShopApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//create products
		restTemplate.postForLocation("http://localhost:8081/products", new ProductDTO("A35","TV",450.0));
		restTemplate.postForLocation("http://localhost:8081/products", new ProductDTO("A34","MP3 Player",75.0));

		//add product to the shoppingcart
		restTemplate.postForLocation("http://localhost:8080/cart/1",new AddToCartDTO("A35",3));
		//add product to the shoppingcart
